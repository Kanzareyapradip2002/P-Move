...
const Jailer = 'http://localhost:3000/Move/Jailer.zip'
...
const SoPage1 = () =>{
 ...
 return(
    <>
    <img className='img1' src={require("./img/SouthMvoieimg/jailer1.jpg")} alt="" />
    ...
    <div><button className='ButtanDownloads'onClick={()=>{DownloadURl(Jailer)} }>Downloads</button></div>
